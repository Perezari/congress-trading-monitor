        ...
        {ranked.map((f, i) => {
          ...
          return (
            <button
              ...
              className="w-full grid grid-cols-[28px_minmax(0,1fr)_80px_112px] gap-3 px-4 py-[10px] items-center text-left even:bg-[lch(95.5%_0_282)] hover:bg-muted"
            >
              <RankBadge rank={i + 1} />
              ...
              <span className="text-small text-warn font-semibold tabular-nums text-right">
                {sharePct.toFixed(0)}%
              </span>
