    ...
    <header className="border-b border-stroke bg-canvas/95 backdrop-blur sticky top-0 z-30">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 h-12 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="hidden sm:inline-flex items-center gap-1 text-mini text-[#10b981] ml-1.5 whitespace-nowrap">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="ml-4 inline-flex items-center gap-[2px] text-mini text-ink_faint">
